<div class="border border-gray-400/20 rounded-xl">
    <div class="flex items-center h-16 px-6 border-b border-gray-400/20">
    ...
    @if ($currentStep >= $step)
        <div class="p-6 space-y-4">
            <div class="flex gap-4">
                ...
                ]) type="button" wire:click.prevent="$set('paymentType', 'card')">
                    Pay by card
                </button>
            ...
            @if ($paymentType == 'cash-in-hand')
                <form wire:submit="checkout">
                    <div
                        class="p-4 text-sm text-center text-gray-400 rounded-lg bg-scarlet-50 border border-scarlet-500">
                        Payment is offline, no card details needed.
                    </div>

                    <button
                        class="px-5 py-3 mt-4 text-sm font-medium text-white bg-scarlet-600 rounded-lg hover:bg-scarlet-500"
                        type="submit" wire:key="payment_submit_btn">
